            ...
            <Grid container spacing={2}>
              ...
              <Grid xs={8} md={8}>
                <Item style={{ padding: "30px 50px" }}>
                  <Typography variant="h5" textAlign={"left"}>Student Summary</Typography>
                  <Typography textAlign={"left"}>Current Location : Kerala</Typography>
                  <Typography textAlign={"left"}>Prefereed Location : Anywhere in India</Typography>
